<?php
/**
 * Amy's Eden Senior Care - Archive Template
 *
    ...
    <section class="blog-hero">
        <div class="container">
            ...
            <?php if ( get_the_archive_description() ) : ?>
                <div class="blog-hero__subtitle"><?php the_archive_description(); ?></div>
            <?php endif; ?>
            ...
            <div class="blog-main">
                ...
                <?php else : ?>
                    ...
                    <div class="blog-no-posts">
                        ...
                        <p>There are no posts matching this archive. Try browsing our <a href="<?php echo esc_url( home_url( '/blog/' ) ); ?>" style="color:#EE5F3D;">latest articles</a> instead.</p>
                    </div>
