...
function amyseden_scripts() {
    ...
    // Main theme CSS
    wp_enqueue_style('amyseden-main', get_template_directory_uri() . '/assets/css/main.css', array(), '1.7.1');

    // Main theme JS (deferred)
    wp_enqueue_script('amyseden-main', get_template_directory_uri() . '/assets/js/main.js', array(), '1.7.1', true);
